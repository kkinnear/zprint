...
```
% ./zprintm-1.1.1 -lfsc src/zprint/*.cljc
...
```
 % ./zprintm-1.1.1 '{:width 90}' -lfsc src/zprint/*.cljc
Processing file src/zprint/ansi.cljc
Processing file src/zprint/config.cljc
Formatting required in file src/zprint/config.cljc
Processing file src/zprint/core.cljc
...
## 4. Lein zprint
  * Leiningen plugin: `[lein-zprint "1.1.1"]`
...
```
__Get it__: put `[lein-zprint "1.1.1"]` in the vector that is the value of
