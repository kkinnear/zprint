...
(expect
"(m/app\n  :get  (m/app\n          middle1\n          middle2\n          middle3\n          [route] handler\n          [route] handler)\n  :post (m/app\n          middle\n          of\n          the\n          road\n          [route] handler\n          [route] handler))"
(zprint-str mapp3 {:parse-string? true :fn-map {"m/app" [:guided {:list {:option-fn moustacheguide}}]}}))
...
'(rum/defcs component
  "This is a component with a doc-string!  How unusual..."
  {:a :b "this" [is a test] :c [this is a very long vector how do you suppose it will work]} rum/static
                       rum/reactive
                       (rum/local 0 :count)
                       (rum/local "" :text)
  [state label]
